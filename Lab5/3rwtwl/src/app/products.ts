...
export const products = [
  {
    ...
    name: 'iPphone 13',
    image:
      'https://resources.cdn-kaspi.kz/shop/medias/sys_master/images/images/h42/hed/46392661704734/apple-iphone-13-128gb-sinij-102298364-1-Container.jpg',
    images: [
...

  {
    ...
    name: 'iPhone 14',
    image:
      'https://resources.cdn-kaspi.kz/shop/medias/sys_master/images/images/h1f/h05/63072540098590/apple-iphone-14-128gb-cernyj-106363023-1.jpg',
    images: [
...

  {
    ...
    name: 'iPhone 14 Pro',
    image:
      'https://resources.cdn-kaspi.kz/shop/medias/sys_master/images/images/h93/hd8/62948780081182/apple-iphone-14-pro-max-128gb-fioletovyj-106363303-1.jpg',
    images: [
    ...
    price: 637000,
    description:
      'OLED-дисплей диагональю 6,1 дюйма и разрешением 2556 × 1179 точек',
    rating: 5,
...

  {
    ...
    image:
      'https://resources.cdn-kaspi.kz/shop/medias/sys_master/images/images/h0a/hb3/63073422966814/apple-iphone-14-pro-max-128gb-cernyj-106363289-1.jpg',
    images: [
...

  {
    ...
    name: 'iPhone 12',
    image:
      'https://resources.cdn-kaspi.kz/shop/medias/sys_master/images/images/he9/h2e/33282180907038/apple-iphone-12-128gb-belyj-100656959-1-Container.jpg',
    images: [
...

  {
    ...
    name: 'iPhone 14 Plus',
    image:
      'https://resources.cdn-kaspi.kz/shop/medias/sys_master/images/images/h88/h2c/63073066909726/apple-iphone-14-plus-128gb-cernyj-106363170-1.jpg',
    images: [
    ...
    price: 480000,
    description:
      'Смартфон iPhone 14 Plus технически почти не отличается от iPhone 14',
    rating: 5,
...

  {
    ...
    name: 'iPhone 12 mini',
    image:
      'https://resources.cdn-kaspi.kz/shop/medias/sys_master/images/images/hb3/h20/33277048422430/apple-iphone-12-mini-64gb-cernyj-100657220-1-Container.jpg',
    images: [
    ...
    price: 294000,
    description:
      'Apple iPhone 12 mini отличается новым элегантным дизайном без закругления граней',
    rating: 5,
...

  {
    ...
    name: 'iPhone SE',
    image:
      'https://resources.cdn-kaspi.kz/shop/medias/sys_master/images/images/h54/hb0/33080094326814/apple-iphone-se-2020-64gb-slim-box-krasnyj-100692722-1-Container.jpg',
    images: [
    ...
    price: 235000,
    description:
      'Apple iPhone SE 2-го поколения — мощный смартфон с процессором A13 Bionic',
    rating: 5,
...

  {
    ...
    name: 'iPhone 12 mini',
    image:
      'https://resources.cdn-kaspi.kz/shop/medias/sys_master/images/images/hdd/he3/33279999180830/apple-iphone-12-mini-64gb-krasnyj-100657851-1-Container.jpg',
    images: [
    ...
    price: 325000,
    description:
      'Использующий процессор Apple A12 Bionic который содержит 7 миллиардов',
    rating: 5,
    link: 'https://kaspi.kz/shop/p/apple-iphone-12-mini-64gb-krasnyi-100657851/?c=750000000',
  },
];
